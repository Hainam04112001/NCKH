...
export const NavBar = () => {
    ...
    const [isMobileMenuOpen, seIsMobileMunuOpen] = useState(false);
    ...
    const toggleMobileMenu = () => {
        seIsMobileMunuOpen(!isMobileMenuOpen)
    };
    ...
    useEffect(() => {
        const handleScroll = () => {
            const currenPosition = window.pageYOffset;
            setScrollPosition(currenPosition);
        };
        ...
        top-0 transition-colors duration-500 ease-in-out w-full z-10`}>
            <div className="lg:w-[95%] mx-auto sm:px-6 lg:px-6">
                <div className="px-4 py-4 flex items-center justify-between">
                    {/* Logo */}
                    <div onClick={() => navigete('/')} className="flex-shrink-0 cursor-pointer pl-7 ,d:p-0 flex items-center">
                        <div><h1><img src="/logo1.png" alt="Logo" className="w-32 h-auto" /></h1></div>
                    </div>
